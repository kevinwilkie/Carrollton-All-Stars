...
function renderStandings() {
  ...
  if (!teams.length) return host.innerHTML =
    `<div class="card"><h3>Standings</h3><p class="hint">No teams yet — the commissioner seeds the league from the Admin tab.</p></div>`;
  ...
  host.innerHTML =
    ...
    `<span class="pill pill-gold">Top ${cut} make the playoffs · seeds 1–2 get a bye</span></div>` +
    `<div class="card"><table class="standings-table">` +
